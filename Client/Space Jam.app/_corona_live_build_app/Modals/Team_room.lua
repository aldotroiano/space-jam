...
Team_room_group = self.view
  ...
  modal_background.strokeWidth = 11
  modal_background:setStrokeColor(255,255,255)

  local lbl_team_name = display.newText("TEAM : ".._G.team_name,65,display.contentCenterY-260,"fonts/FallingSky.otf",45 )
  ...
  bx_leave_room:addEventListener( "tap" , action_cancel)
  ...
  bx_start:addEventListener( "tap" , action_go)

  local lbl_leave_room = display.newText("L E A V E",120,display.contentCenterY+210,"fonts/delirium.ttf",65 )
  lbl_leave_room.anchorX = 0
  lbl_leave_room:setFillColor(255,255,255)

  local lbl_start = display.newText("S T A R T",display.actualContentWidth-110,display.contentCenterY+210,"fonts/delirium.ttf",65 )
  lbl_start.anchorX = 1
